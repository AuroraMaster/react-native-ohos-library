...
| 3.2.10      | [@react-native-ohos/react-native-swipe-list-view Releases]()     | 0.77       |
...
```bash
# V3.2.9
npm install @react-native-oh-tpl/react-native-swipe-list-view

# V3.2.10
npm install @react-native-ohos/react-native-swipe-list-view
```
