...
| ---- | ----------- | ---- | -------- | -------- | ------------------ | ---- |
| save | 保存图片/视频 | function | no | iOS/Android | partially | 由于原库版本升级，该方法已弃用，可用saveAsset接口代替。<br />图片支持格式：png/jpg/jpeg/heif/bmp/gif/webp/svg/heic<br />视频支持格式：mp4/mov |
| saveAsset | 保存图片/视频 | function | no | iOS/Android | partially | 图片支持格式：png/jpg/jpeg/heif/bmp/gif/webp/svg/heic<br />视频支持格式：mp4/mov |
| saveToCameraRoll | 保存图片/视频 | function | no | iOS/Android | partially | 由于原库版本升级，该方法已弃用，调用会弹出警告，可用saveAsset接口代替。<br />图片支持格式：png/jpg/jpeg/heif/bmp/gif/webp/svg/heic<br />视频支持格式：mp4/mov |
