...
请到三方库相应的 Releases 发布地址查看 Release 配套的版本信息：[<HarmonyOS npm 包名> Releases](https://gitcode.com/openharmony-sig/仓库名/releases)

提示：[@react-native-ohos/react-native-linear-gradient Releases](https://gitcode.com/openharmony-sig/rntpc_react-native-linear-gradient/releases)（删除）
...
例子：本项目基于 [The MIT License (MIT)](https://gitcode.com/openharmony-sig/rntpc_react-native-linear-gradient/blob/master/LICENSE) ，请自由地享受和参与开源。(删除)
