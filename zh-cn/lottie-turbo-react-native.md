...
> [!TIP] [Github 地址](https://github.com/lottie-react-native/lottie-react-native)
...
请到三方库相应的 Releases 发布地址查看 Release 配套的版本信息：[@react-native-ohos/lottie-turbo-react-native Releases](https://gitcode.com/OpenHarmony-RN/rntpc_lottie-turbo-react-native/releases)
...
- 如果使用的 json 文件里有依赖图片资源或使用 imageAssetsFolder 属性，需要将资源文件放置到 HarmonyOS 工程 resfile 下对应的路径中

resfile 路径：`entry/src/main/resources/resfile`
...
- [ ] 原库部分接口在 HarmonyOS 中没有对应属性及接口处理相关逻辑，问题: [issue#2](https://gitcode.com/OpenHarmony-RN/rntpc_lottie-turbo-react-native/issues/2)
