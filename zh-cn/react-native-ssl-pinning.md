...
| 三方库版本  | 发布信息                                                  | 支持RN版本 |
|--------| ------------------------------------------------------------ | ---------- |
| <= 1.5.7-0.0.2@deprecated  | [@react-native-oh-tpl/react-native-ssl-pinning Releases(deprecated)](https://github.com/react-native-oh-library/react-native-ssl-pinning/releases) | 0.72       |
...
### 3.配置 CMakeLists 和引入 SslPinningPackage

> 若使用的是 <= 1.5.7-0.0.2 版本，请跳过本章。
...
### 4.在 ArkTs 侧引入 SslPinningPackage
