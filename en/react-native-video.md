...
> [!TIP] Versions >=5.2.3 need to run on DevEco Studio 5.0.1(API13) or later.
...
- [ ] Some interfaces of the original library in V6.13.0 do not have corresponding attributes or interface support in HarmonyOS：  [issue#153](https://github.com/react-native-oh-library/react-native-video/issues/153)
