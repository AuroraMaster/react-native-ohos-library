...
| tapToHideKeyboard              | Whether to hide the keyboard when tapping LargeList                                                                                                                                                                                                             | boolean                                                                                                       | no       | Android/iOS | no(deprecated from react-native-spring-scrollview 3.x version ) |
