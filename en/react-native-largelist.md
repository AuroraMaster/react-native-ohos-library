...
| tapToHideKeyboard              | Whether to hide the keyboard when tapping LargeList                                                                                                                                                                                                             | boolean                                                                                                       | no       | Android/iOS | no |
...
| dragToHideKeyboard             | Whether to hide the keyboard when dragging the screen                                                                                                                                                                                                                | boolean                                                                                                       | no       | Android/iOS | yes |
