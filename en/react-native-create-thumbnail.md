...
Version >= @react-native-ohos/react-native-create-thumbnail@2.0.1 now supports Autolink without requiring manual configuration, currently only supports 72 frameworks.
