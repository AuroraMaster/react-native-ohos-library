...
> [!TIP] Version >= 3.2.5 no need to execute Codegen
...
### 3.Configure CMakeLists and import VoicePackage

> [!TIP] If using version 3.2.4, please skip this chapter
...
### 4. Introducing RNVoicePackage to ArkTS
