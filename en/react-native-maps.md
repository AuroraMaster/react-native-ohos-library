...
| ---------- | ------------------------------------------------------------ | ---------- |
| <= 1.10.3-0.1.4@deprecated  | [@react-native-oh-tpl/react-native-maps Releases(deprecated)](https://github.com/react-native-oh-library/react-native-maps/releases) | 0.72       |
...
> If you are using version <= 1.10.3-0.1.4, please skip this chapter.
