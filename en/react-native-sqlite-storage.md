...
class SQLiteDemo extends Component {
  ...
  populateDB = tx => {
    ...
    tx.executeSql(
      'INSERT INTO Offices (name, longtitude, latitude) VALUES ("City", 59.8,  34.);',
      [],
    );
    tx.executeSql(
    ...
    tx.executeSql(
      'INSERT INTO Employees (name, office, department, custom_info) VALUES ("Sen Sen", 2, 4, \'{"known": true}\')',
      [],
    );
    tx.executeSql(
      'INSERT INTO Employees (name, office, department, custom_info) VALUES ("Eleven", 2, 4, \'{"known": true}\')',
      [],
    );
    tx.executeSql(
      'INSERT INTO Employees (name, office, department, custom_info) VALUES ("Nine", 3, 4, \'{"known": true}\')',
      [],
    );
    tx.executeSql(
      'INSERT INTO Employees (name, office, department, custom_info) VALUES ("Fine", 3, 3, \'{"known": true}\')',
      [],
    );
    tx.executeSql(
