...
| ---------- | ------------------------------------------------------------ | ---------- |
| <= 0.3.0-0.0.1@deprecated  | [@react-native-oh-tpl/react-native-mlkit-ocr Releases(deprecated)](https://github.com/react-native-oh-library/react-native-mlkit-ocr/releases) | 0.72       |
...
> If you are using version <= 0.3.0-0.0.1, please skip this chapter.
