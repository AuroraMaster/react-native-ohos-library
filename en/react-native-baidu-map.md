...
| ---------- | ------------------------------------------------------------ | ---------- |
| <= 1.0.37-0.0.5@deprecated  | [@react-native-oh-tpl/react-native-baidu-map Releases(deprecated)](https://github.com/react-native-oh-library/react-native-baidu-map/releases) | 0.72       |
...
> If you are using version <= 1.0.37-0.0.5, please skip this chapter.
