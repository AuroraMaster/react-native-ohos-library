...
| ---------- | ------------------------------------------------------------ | ---------- |
| <= 0.6.7-0.2.18@deprecated  | [@react-native-oh-tpl/react-native-smartrefreshlayout Releases(deprecated)](https://github.com/react-native-oh-library/react-native-smartrefreshlayout/releases) | 0.72       |
...
| ~0.7.0                               |  No                   |  0.77                |
| ~0.6.8                               |  Yes                  |  0.72                |
| <= 0.6.7-0.2.18@deprecated           |  No                   |  0.72                |
...
### 4. Introducing SmartRefreshPackage to ArkTS
