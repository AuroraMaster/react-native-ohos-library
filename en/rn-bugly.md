...
| ---------- | ------------------------------------------------------------ | ---------- |
| <= 1.3.0-beta.3-0.0.1@deprecated  | [@react-native-oh-tpl/rn-bugly Releases(deprecated)](https://github.com/react-native-oh-library/rn-bugly/releases) | 0.72       |
...
> If you are using version <= 1.3.0-beta.3-0.0.1, please skip this chapter.
