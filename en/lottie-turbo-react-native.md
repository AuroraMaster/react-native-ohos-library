...
<p align="center">
  <h1 align="center"> <code>lottie-turbo-react-native</code> </h1>
</p>
<p align="center">
...
> [!TIP] [GitHub address](https://github.com/lottie-react-native/lottie-react-native)
...
| --------------------------- | --------------------------------------------------------------- | -------------------- |
| 1.0.0                       | [@react-native-ohos/lottie-turbo-react-native Releases](https://gitcode.com/OpenHarmony-RN/rntpc_lottie-turbo-react-native/releases) | 0.72/0.77       |
...
```bash
npm install @react-native-ohos/lottie-turbo-react-native
```

#### **yarn**

```bash
yarn add @react-native-ohos/lottie-turbo-react-native
```
...
"dependencies": {
    ...
    "@react-native-ohos/lottie-turbo-react-native": "file:../../node_modules/@react-native-ohos/lottie-turbo-react-native/harmony/lottie.har"
  }
```
...
+ add_subdirectory("${OH_MODULES}/@react-native-ohos/lottie-turbo-react-native/src/main/cpp" ./lottie-turbo)
...
Check the release version information in the release address of the third-party library: [@react-native-ohos/lottie-turbo-react-native Releases](https://gitcode.com/OpenHarmony-RN/rntpc_lottie-turbo-react-native/releases)
...
- If the JSON file used has dependent image resources or uses the imageAssetsFolder property, the resource file needs to be placed in the corresponding path under the HarmonyOS project resfile

resfile path：`entry/src/main/resources/resfile`
...
| onAnimationLoop    | Only Windows and Web. A callback function invoked when the animation loops.                                                                                                                                                                                                                                                                                    | callback                                    | None      | No       | Windows, Web          | Yes                |
...
- [ ] Some interfaces in the original library do not have corresponding properties and interface processing logic in HarmonyOS. Problem: [issue#2](https://gitcode.com/OpenHarmony-RN/rntpc_lottie-turbo-react-native/issues/2)
