...
This project is based on [原库 npm 名称](原库仓库连接).
...
Example: This project is licensed under [MIT License](https://gitcode.com/openharmony-sig/rntpc_react-native-linear-gradient/blob/master/LICENSE). (Delete)
