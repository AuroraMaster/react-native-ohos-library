...
| ---------- | ------------------------------------------------------------ | ---------- |
| <= 2.0.3-0.0.5@deprecated  | [@react-native-oh-tpl/audio-toolkit Releases(deprecated)](https://github.com/react-native-oh-library/react-native-audio-toolkit/releases) | 0.72       |
...
"dependencies": {
    ...
    "@react-native-ohos/audio-toolkit": "file:../../node_modules/@react-native-ohos/audio-toolkit/harmony/audio_toolkit.har"
  }
```
...
### 4. Configuring CMakeLists and Introducing  AudioToolkitPackage

> If you are using version <= 2.0.3-0.0.5, please skip this chapter.
