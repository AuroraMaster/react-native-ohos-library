...
> [!TIP] After integrating autolink, RNKeyboardControllerPackage and RNStatusBarManagerCompatPackage are merged and exported as RNKeyboardControllerPackage class, no changes needed on the user side.
